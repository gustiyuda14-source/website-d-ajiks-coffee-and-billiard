...
export const metadata: Metadata = {
  ...
  // og:image / twitter:image are generated by app/opengraph-image.tsx (one
  // branded card — logo + tagline on the brand gradient — reused for every
  // route), not a raw venue photo. Don't set `images` here or it overrides
  // the generated one.
  openGraph: {
